...
const Demonstration = () => {
  ...
  return (
    <section className="w-full flex flex-col  relative">
      {/* Curved background div */}
      {/* <CurvedDivision bgColor="bg-[#F2DDC6]" position="top" intensity={10} reversed={true}/> */}

      {/* Content container - must be positioned relative to appear above the curved background */}
      <div className="relative z-10 px-8 sm:px-12 md:px-16 xl:px-[8%] 2xl:px-[20%]">
        {/* Image/Content Section */}
        <div className="flex gap-8 mb-8 justify-center">
          <div
            className={`relative w-full rounded-4xl shadow-xl overflow-hidden transition-colors duration-500 border border-double ${activeTabData.borderColor} aspect-video bg-white`}
          >
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <p className="text-center text-lg text-neutral-500 font-semibold hidden sm:block px-40">
